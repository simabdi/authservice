...
// Register new user
func (s *AuthServiceServer) Register(ctx context.Context, req *pb.RegisterRequest, db *gorm.DB) (*pb.RegisterResponse, error) {
...
func (s *AuthServiceServer) Login(ctx context.Context, req *pb.LoginRequest, db *gorm.DB) (*pb.LoginResponse, error) {
